...
- `git diff --check 0feee81f70bb89abd2479a8bde789b0040bab9c8..HEAD`
...
- `python scripts/agent_trace_ui.py --trace-root artifacts\ai_trading_team_example_benchmarks\20260826_225104_202238\qqq-historical-equity-only-llm\cache\agent_runtime`

## Results

- Pytest: `194 passed, 3 warnings`.
...
- Smoke artifact: `artifacts\ai_trading_team_example_benchmarks\20260826_225104_202238\qqq-historical-equity-only-llm`.
...
- Pruned model-facing excerpt preserves `evidence_profile="momentum_stage"`: yes.
- Pruned model-facing excerpt preserves benchmark context with `return_126`: yes.
